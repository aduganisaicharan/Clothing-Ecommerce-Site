...
import userModel from "../models/userModel.js";  // import user model to access the user collection in mongodb
...
const registerUser = async(req,res)=>{
    try{
        ...
        const user = await newUser.save() // whenever user is created then id also generated by default
        //  - using id we generate the token, here in createToken function we return token using jwt package 
        const token = createToken(user._id);
        res.json({success:true, token})
