...
// using fields we process multipart form data 
// // use this middleware in appproduct route because on this route we have to send multiple images that will be passed using the multiple middle ware
productRouter.post('/remove',adminAuth, removeProduct);
productRouter.post('/single',singleProduct);
productRouter.get('/list',listProducts);
// hence we created these 4 routes using this controller function
// add product route will be used to add the product
